...
BP_PATH = "build/Areas BP"
RP_PATH = "build/Areas RP"
BP_SCRIPTS_PATH = "build/Areas BP/scripts"
MAIN_MANIFEST_PATH = "main-manifest.json"
BP_MANIFEST_PATH = "build/Areas BP/manifest.json"
RP_MANIFEST_PATH = "build/Areas RP/manifest.json"

OUTPUT_FILE = f"build/areas.mcaddon"
OUTPUT_FILE_BP = f"build/areas-bp.mcpack"
OUTPUT_FILE_RP = f"build/areas-rp.mcpack"
